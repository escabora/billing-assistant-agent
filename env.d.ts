/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 52a731b49a61409cea81ded393411dac)
// Runtime types generated with workerd@1.20260721.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	BillingAgent: DurableObjectNamespace<import("./src/server").BillingAgent>;
	INVOICE_RUN: Workflow<Parameters<import("./src/server").InvoiceRunWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "BillingAgent";
	}
